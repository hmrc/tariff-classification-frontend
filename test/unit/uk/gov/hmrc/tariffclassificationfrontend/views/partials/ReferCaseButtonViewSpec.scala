...
import uk.gov.hmrc.tariffclassificationfrontend.views.html.partials.refer_case_button
import uk.gov.tariffclassificationfrontend.utils.Cases

class ReferCaseButtonViewSpec extends ViewSpec {

  "Refer Case Button" should {

    "render button for OPEN case" in {
      val case1 = Cases.btiCaseExample.copy(status = CaseStatus.OPEN)

      // When
      val doc = view(refer_case_button(case1))

      // Then
      doc should containElementWithID("refer-case-button")
      doc.getElementById("refer-case-button") should haveAttribute("href", "/tariff-classification/cases/1/refer")
    }
