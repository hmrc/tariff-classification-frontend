...
class SuspendCaseButtonViewSpec extends ViewSpec {

  "Suspend Case Button" should {
    ...
    "render button for OPEN case" in {
      ...
      doc.getElementById("suspend-case-button") should haveAttribute("href", "/tariff-classification/cases/1/suspend")
    }
