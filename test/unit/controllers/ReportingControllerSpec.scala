  ...
  "GET Reports" should {
    "Return OK" in {
      ...
      contentAsString(result) shouldBe views.html
        .reports(Seq.empty, None, Map.empty)(req, mcc.messagesApi.preferred(req), realAppConfig)
        .toString()
    }
      ...
      contentAsString(result) shouldBe views.html
        .reports(
          ...
          Some(
            SelectedReport(
              Report.SLA,
              views.html.partials.reports
                .sla_report_criteria(InstantRangeForm.form)(req, mcc.messagesApi.preferred(req), realAppConfig)
            )
          ),
          Map.empty
        )(req, mcc.messagesApi.preferred(req), realAppConfig)
        .toString()
    }
        ...
        .reports(
          ...
          Some(
            SelectedReport(
              Report.REFERRAL,
              views.html.partials.reports
                .referral_report_criteria(InstantRangeForm.form)(req, mcc.messagesApi.preferred(req), realAppConfig)
            )
          ),
          Map.empty
        )(req, mcc.messagesApi.preferred(req), realAppConfig)
      ...
      contentAsString(result) shouldBe views.html
        .reports(
          ...
          Some(
            SelectedReport(
              Report.SLA,
              views.html.partials.reports.sla_report_criteria(InstantRangeForm.form.bind(Map[String, String]()))(
                req,
                mcc.messagesApi.preferred(req),
                realAppConfig
              )
