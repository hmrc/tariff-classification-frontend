  ...
  "Complete Case" should {
    "update case status to COMPLETED" when {
      "Liability" in {
        ...
        await(service.completeCase(originalCase, operator)(hc, fakeRequest, messages)) shouldBe caseUpdated
      ...
      "set the effective end date of an ATaR if an explict end date is defined by the user" in {
        ...
        await(service.completeCase(atarCase, operator)(hc, fakeRequest, messages))
    ...
    "reject case without a decision" in {
      ...
      intercept[IllegalArgumentException] {
        await(service.completeCase(originalCase, operator)(hc, fakeRequest, messages))
      }
