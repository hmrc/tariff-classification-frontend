...
object Permission extends Enumeration {
  ...
  val managerPermissions: Set[Permission] = Set(VIEW_MY_CASES, VIEW_QUEUE_CASES, VIEW_ASSIGNED_CASES, SEARCH, ADVANCED_SEARCH, VIEW_CASES,
    RELEASE_CASE, SUPPRESS_CASE, REFER_CASE, OPEN_CASE, REJECT_CASE, SUSPEND_CASE, COMPLETE_CASE,
  ...
  val teamBasicPermisions: Set[Permission] = Set(VIEW_MY_CASES, VIEW_QUEUE_CASES, SEARCH, ADVANCED_SEARCH, VIEW_CASES,
