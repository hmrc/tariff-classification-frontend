...
object Permission extends Enumeration {
  ...
  val VIEW_MY_CASES, VIEW_QUEUE_CASES, VIEW_ASSIGNED_CASES, SEARCH, ADVANCED_SEARCH, VIEW_CASES,
  RELEASE_CASE, SUPPRESS_CASE, REFER_CASE, OPEN_CASE, REJECT_CASE, SUSPEND_CASE, COMPLETE_CASE,
  ...
  private val managerPermissions: Set[Permission] = Set(VIEW_MY_CASES, VIEW_QUEUE_CASES, VIEW_ASSIGNED_CASES, SEARCH, ADVANCED_SEARCH, VIEW_CASES,
    RELEASE_CASE, SUPPRESS_CASE, REFER_CASE, OPEN_CASE, REJECT_CASE, SUSPEND_CASE, COMPLETE_CASE,
  ...
  val teamCaseOwnerPermissions: Set[Permission] = Set(VIEW_MY_CASES, VIEW_QUEUE_CASES,  SEARCH, ADVANCED_SEARCH, VIEW_CASES,
    RELEASE_CASE, SUPPRESS_CASE, REFER_CASE, OPEN_CASE, REJECT_CASE, SUSPEND_CASE, COMPLETE_CASE,
    CANCEL_CASE, ADD_NOTE, ADD_ATTACHMENT, KEYWORDS, EDIT_RULING, APPEAL_CASE, REVIEW_CASE, EXTENDED_USE, MOVE_CASE_BACK_TO_QUEUE)

  private val teamBasicPermissions: Set[Permission] = Set(VIEW_MY_CASES, VIEW_QUEUE_CASES, SEARCH, ADVANCED_SEARCH, VIEW_CASES,
    RELEASE_CASE, SUPPRESS_CASE, OPEN_CASE,
