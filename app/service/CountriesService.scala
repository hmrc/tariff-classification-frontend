...
class CountriesService {
  ...
  lazy val getAllCountriesById: Map[String, Country] = countries.map(country => (country.code, country)).toMap
  ...
  private val countries = List(
    ...
    Country("SH-AC", "title.ascension", "SH-AC", Nil),
    ...
    Country("UM-81", "title.baker_island", "UM-81", Nil),
    ...
    Country("BQ-BO", "title.bonaire", "BQ-BO", Nil),
    ...
    Country("BAT", "title.british_antarctic_territory", "BAT", Nil),
    ...
    Country("ES-CE", "title.ceuta", "ES-CE", Nil),
    ...
    Country("AE-DU", "title.dubai", "AE-DU", Nil),
    ...
    Country("AE-FU", "title.fujairah", "AE-FU", Nil),
    ...
    Country("UM-84", "title.howland_islands", "UM-84", Nil),
    ...
    Country("UM-86", "title.jarvis_islands", "UM-86", Nil),
    Country("JP", "title.japan", "JP", Nil),
    Country("JE", "title.jersey", "JE", List("Channel Islands")),
    Country("UM-67", "title.johnston_atoll", "UM-67", Nil),
    ...
    Country("ES-ML", "title.melilla", "ES-ML", Nil),
    Country("MX", "title.mexico", "MX", Nil),
    Country("FM", "title.micronesia", "FM", Nil),
    Country("UM-71", "title.midway_island", "UM-71", Nil),
    ...
    Country("AE-RK", "title.ras_al_khaimah", "AE-RK", Nil),
    ...
    Country("BQ-SA", "title.saba", "BQ-SA", Nil),
    Country("WS", "title.samoa", "WS", List("Western Samoa")),
    Country("BL", "title.saint_barthelemy", "BL", List("Barthélemy", "Barthelemy")),
    Country("BQ-SE", "title.st_eustatius", "BQ-SE", Nil),
    Country("KN", "title.saint_kitts_and_nevis", "KN", List("St Kitts")),
    Country("SH-HL", "title.saint_helena_ascension_and_tristan_da_cunha", "SH-HL", List("St Helena")),
    Country("LC", "title.saint_lucia", "LC", List("St Lucia")),
    Country("MF", "title.saint_martin_north", "MF", Nil),
    Country("SX", "title.sint_maarten_south", "SX", Nil),
    ...
    Country("AE-SH", "title.sharjah", "AE-SH", Nil),
    ...
    Country("SJ", "title.svalbard_archipelago", "SJ", Nil),
    ...
    Country("SH-TA", "title.tristan_da_cunha", "SH-TA", Nil),
    ...
    Country("UM-79", "title.wake_island", "UM-79", Nil),
