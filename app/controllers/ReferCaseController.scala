...
class ReferCaseController @Inject() (
  ...
  val refer_case_reason: views.html.refer_case_reason,
  val refer_case_email: views.html.refer_case_email,
  val confirm_refer_case: views.html.confirm_refer_case,
